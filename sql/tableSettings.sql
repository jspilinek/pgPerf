\o 'html/output/tableSettings.html'
\qecho <!DOCTYPE html>
\qecho <html>
\qecho    <head>
\qecho        <title>Table specific settings and optimizations: e.g. autovacuum, statistics</title>
\qecho        <link rel="stylesheet" type="text/css" href="../static/pgPerf.css"/>
\qecho        <script src="../static/sorttable.js"></script>
\qecho    </head>
\qecho    <body>
\qecho        
\qecho        <h1>Table specific settings and optimizations: e.g. autovacuum, statistics</h1>
\qecho        <hr>
\qecho        <br>
